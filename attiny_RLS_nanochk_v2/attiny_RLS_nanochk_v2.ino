...
void RLS_set_read() {
  RLS_unlock();
  mySerial.print(0x54); delay(5);    // Continues Read = 'T'
  mySerial.print(0x01); delay(5);    // Auto-start enable = 1
  mySerial.print(0x33); delay(5);    // Short response = '3'
  mySerial.print(0x00); delay(5);    // Period (250 micro-sec) (byte 8)
  mySerial.print(0xFA); delay(5);    // Period (250 micro-sec) (byte 9)
...
void RLS_unlock() {
  mySerial.print(0xCD); delay(5);
  mySerial.print(0xEF); delay(5);
  mySerial.print(0x89); delay(5);
  mySerial.print(0xAB); delay(5);
}

void RLS_save_conf() {
  RLS_unlock();
  mySerial.print(0x63); delay(5);    // save configuration parameters = 'c'
